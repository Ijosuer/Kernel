...
/* libreria para la primer llamada*/
#include <linux/time.h>

/* librerias pra la segudna llamada*/
#include <linux/jiffies.h>
#include <linux/ktime.h>
/* librerias para la tercer llamada*/
...
/* funcion que devuleve la hora en segundos */
SYSCALL_DEFINE0(reaaltime)
{
...
/* funcion que devuelve el tiempo en segundos desde el ultimo reinicio*/
SYSCALL_DEFINE0(upptimesec)
{
	struct timespec64 ts;
...
/* funcion que devuelve los 5 logs*/
/* funcion que devuelve los 5 logs*/
#define MAX_LOG_ENTRIES 5
#define KERNEL_LOG_BUFFER_SIZE 1024


SYSCALL_DEFINE2(getlogskernelss, char __user *, user_log_buffer, size_t, buffer_length) {
