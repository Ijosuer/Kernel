...
/* syscall para la hora actual en segundos */
asmlinkage long sys_reaaltime(void);

/*syscall para el tiempo en segundos desde el ultimo reinicio*/
asmlinkage  long sys_upptimesec(void);
/*syscall para los logs del kernel*/
asmlinkage long sys_getlogskernelss(char __user *buffer, size_t size);
